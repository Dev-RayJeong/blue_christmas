...
class CustomListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //   child:
      FutureBuilder<bool>(
        future: PreferencesHelper.getBool('read$index'), //
        builder: (context, snapshot) {
          bool read = snapshot.data;
          print(read);
          Color listColor = postList[index]["type"] == "section" ?
                      read == true ? Colors.blueGrey[200] : Colors.blueGrey
                      : read == true ? Colors.grey[300] : Colors.white;
          return Container(
            height: 48,
            padding:  EdgeInsets.only(left: 8.0, right: 8.0),
            decoration: new BoxDecoration(
              border: Border(bottom: BorderSide(width: 0.5, color: Colors.blueGrey)),
              color: listColor
            ),
            child: Row(
              ...
              children: <Widget>[
                Text(
                  ...
                  style: TextStyle(
                    ...
                    color: postList[index]["type"] == "section" ? Colors.white : Colors.black
                  ),
                ),
                Text(
                  postList[index]["author"] == null ? '' : postList[index]["author"],
                  maxLines: 2,
                  overflow: TextOverflow.ellipsis,
            ...
            Container(
              ...
              child: Container (
                decoration: BoxDecoration(
                  border: Border(bottom: BorderSide(width: 1.5, color: Colors.blueGrey))
                ),
                padding: const EdgeInsets.symmetric(vertical: 4.0),
                child: Row(
                  children: <Widget>[
